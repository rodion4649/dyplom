        ...
        <>
            ...
            <div className="page-container">
                ...
                <div>
                    ...
                    {isQuestionsModalShown && <Modal onClose={() => { setIsQuestionModalShown(false) }}>
                        <CreateQuestionForm onSubmit={(newQuestion) => {
                            console.log(newQuestion);
                            setQuestionsList(() => { return [...questionsList, newQuestion] });
                            setIsQuestionModalShown(false)
                        }} />
                    </Modal>}

                    {isImportModalShown && <Modal onClose={() => { setIsImportModalShown(false) }}>
                        <div className="import-modal">
                            ...
                            />
                            {importedFile && <button className="button" onClick={() => {
                    ...
                    <div className="buttons-container" >
                        ...
                        <button className="button" onClick={() => {
                            ...
                            const csvContent = questionsList.map(q =>
                                `${q.questionType},${q.points},${q.questionText}`
                            ).join("\n");
                        ...
                        {questionsList.map((question, index) => {
                            return (<div className="table-row">
                                ...
                                <div className="flex mr-[8px]">
                                    ...
                                    <div className="table-cell w-[24px]">
                                        <button onClick={() => {
                                            setQuestionsList(questionsList.filter((e) => e !== question));
                                        }}>
                                            <DeleteIcon />
                                        </button>
                                    </div>
                    ...
                    <button className="button" onClick={() => { setIsQuestionModalShown(true) }}>
                        Створити питання
                    </button>
                </div>
            </div>
